                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 offset-xl-1 col-xl-10">
                            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="shadow" id="form-gestor" novalidate>
                                <h3 class="mt-1 mb-3 text-center">Editar Avisos</h3>

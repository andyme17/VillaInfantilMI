        ...
        <div class="container">
            <div class="row">
                <div class="col-12 offset-lg-1 col-lg-10">
                    <form action="" method="" class="f1 shadow" novalidate>
                        ...
                        <div class="container">
                            ...
                            <div class="form-row mt-2">
                                ...
                                <div class="form-radio col-12 col-sm-3 mt-2 mt-sm-0">
                                    ...
                                    <div class="form-row pt-2 pt-sm-0 pb-sm-2 text-center">
                                        <div class="col-6">
                                            <input type="radio" id="g" name="genero" value="f">
                                            <label for="f">F</label>
                                        </div>
                                        <div class="col-6">
                            ...
                            <div class="f1-button">
                                <button type="submit" class="btn btn-form-primary btn-next">Enviar ></button>
                            </div>
                        </div>                        
                    </form>
                </div>
                    ...
                    <div class="col-12 offset-md-1 col-md-10 text-center">
                        ...
                        <div class="f1-buttons">
                            <button type="button" class="btn btn-primary btn-previous">
                                < Anterior</button> <button type="button" class="btn btn-secondary btn-next">Finalizar >
                            </button>
                        </div>
                    </div>
                </div>

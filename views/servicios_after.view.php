                    ...
                    <div class="content-after-2 container">
                        <div class="item-extra-2 mb-3">
                            ...
                            <div class="content-extra-2">  
                                <h4 class="mt-5 mt-sm-4 mt-md-5">Ballet</h4>
                                <div class="cont-btn">
                        ...
                        <div class="item-extra-2 mb-3">
                            ...
                            <div class="content-extra-2">  
                                <h4 class="mt-5 mt-sm-4 mt-md-5">Zumba Kids</h4>
                                <div class="cont-btn">
                                    <a class="btn btn-outline-danger pr-2" href="<?php echo PATH; ?>admin/eliminar_instal.php"><i class="fas fa-trash-alt"></i> Eliminar</a>        
                                </div>                           
                            </div>
                        ...
                        <div class="item-extra-2 mb-3">
                            ...
                            <div class="content-extra-2">  
                                <h4 class="mt-5 mt-sm-4 mt-md-5">Taekwondo</h4>
                                <div class="cont-btn">
                                    <a class="btn btn-outline-danger pr-2" href="<?php echo PATH; ?>admin/eliminar_instal.php"><i class="fas fa-trash-alt"></i> Eliminar</a>        
                                </div>                           
                            </div>
                        ...
                        <div class="item-extra-2 mb-3">
                            ...
                            <div class="content-extra-2">  
                                <h4 class="mt-5 mt-sm-4 mt-md-5">Regularización en Inglés</h4>
                                <div class="cont-btn">
                                    <a class="btn btn-outline-danger pr-2" href="<?php echo PATH; ?>admin/eliminar_instal.php"><i class="fas fa-trash-alt"></i> Eliminar</a>        
                                </div>                           
                            </div>
                        ...
                        <div class="item-extra-2 mb-3">
                            ...
                            <div class="content-extra-2">  
                                <h4 class="mt-5 mt-sm-4 mt-md-5">Regularización en Francés</h4>
                                <div class="cont-btn">
                                    <a class="btn btn-outline-danger pr-2" href="<?php echo PATH; ?>admin/eliminar_instal.php"><i class="fas fa-trash-alt"></i> Eliminar</a>        
                                </div>                           
                            </div>
